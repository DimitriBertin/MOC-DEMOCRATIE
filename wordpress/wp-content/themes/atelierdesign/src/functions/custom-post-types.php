...
function register_custom_post_types() {
    ...
    register_post_type('numero', array(
        'labels' => array(
            'name' => __('Revues', 'textdomain'),
            'singular_name' => __('Revue', 'textdomain'),
            'menu_name' => __('Revues', 'textdomain'),
            'name_admin_bar' => __('Revues', 'textdomain'),
            'add_new' => __('Ajouter une nouvelle revue', 'textdomain'),
            'add_new_item' => __('Ajouter une nouvelle revue', 'textdomain'),
            'new_item' => __('Nouvelle revue', 'textdomain'),
            'edit_item' => __('Modifier la revue', 'textdomain'),
            'view_item' => __('Voir la revue', 'textdomain'),
            'all_items' => __('Tous les revues', 'textdomain'),
            'search_items' => __('Rechercher des revues', 'textdomain'),
            'parent_item_colon' => __('Revues parents :', 'textdomain'),
            'not_found' => __('Aucune revue trouve.', 'textdomain'),
            'not_found_in_trash' => __('Aucune revue trouve dans la corbeille.', 'textdomain'),
        ),
        'public' => true,
        'publicly_queryable' => true,
        'show_ui' => true,
        'show_in_menu' => true,
        'query_var' => true,
        'rewrite' => array('slug' => 'revues', 'with_front' => false),
        'capability_type' => 'post',
        'has_archive' => true,
        'hierarchical' => false,
        'menu_position' => 8,
