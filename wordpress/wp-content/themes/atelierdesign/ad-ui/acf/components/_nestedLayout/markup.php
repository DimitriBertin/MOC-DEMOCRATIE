...
?>
<div class="advanced-layout nested-advanced-layout inline-flexible flex-grid flex-grid-cols-1 md:flex-grid-cols-12 <?= $gapX; ?> <?= $gapY; ?> <?= $justify; ?> <?= $align; ?> <?= $divideX; ?> <?= $divideY; ?> flex-grid-divide-[--color-separator-primary]">
  <?php $adwp->render_flexible_layout($args['_nestedLayout']); ?>
</div>