...
?>
<div class="advanced-layout-wrapper inline-flexible flex-grid-col-span-1 aos animate-fadeinup aos-disable-children animate-delay-[calc((var(--nth,1)-1)*150ms)] <?= $span; ?> <?= $wrapperClass; ?> <?= $disableDividerX; ?> <?= $disableDividerY; ?>">
