...
/**
 * ACF Fields for Advanced Layout
 */
...
$layoutSettingsFields = [
  // [
  //   'key' => 'field-layout-setting-isFullWidth',
  //   'label' => 'Full Width',
  //   'name' => 'isFullWidth',
  //   'type' => 'true_false',
  //   'ui' => 1,
  ...
  [
    'key' => 'field-layout-setting-horizontal-alignment',
  ...
  [
    'key' => 'field-layout-setting-vertical-alignment',
  ...
  [
    'key' => 'field-layout-setting-gap-x',
  ...
  [
    'key' => 'field-layout-setting-gap-y',
  ...
  // [
  //   'key' => 'field-layout-setting-override-mobile-gap-x',
  ...
  // ],
  // [
  //   'key' => 'field-layout-setting-override-mobile-gap-spacer',
  //   'label' => '',
  ...
  // ],
  [
    'key' => 'field-layout-setting-override-mobile-gap-y',
  ...
  // [
  //   'key' => 'field-layout-setting-mobile-gap-x',
  ...
  //     [
  //       [
  //         'field' => 'field-layout-setting-override-mobile-gap-x',
  //         'operator' => '==',
  //         'value' => 1,
  //       ],
  //     ],
  ...
  // ],
  // [
  //   'key' => 'field-layout-setting-mobile-gap-x-spacer',
  //   'label' => '',
  ...
  //     [
  //       [
  //         'field' => 'field-layout-setting-override-mobile-gap-y',
  //         'operator' => '==',
  //         'value' => 1,
  //       ],
  //     ],
  ...
  // ],
  [
    'key' => 'field-layout-setting-mobile-gap-y',
  ...
  [
    'key' => 'field-layout-setting-mobile-gap-y-spacer',
    'label' => '',
  ...
  [
    'key' => 'field-layout-setting-divide-x',
  ...
  [
    'key' => 'field-layout-setting-divide-y',
  ...
  [
    'key' => 'field-layout-setting-full-width-divide-y-spacer',
    'label' => '',
    ...
    'conditional_logic' => [
      [
        [
          'field' => 'field-layout-setting-divide-y',
          'operator' => '==',
          'value' => 1,
        ],
      ],
  ...
  [
    'key' => 'field-layout-setting-full-width-divide-y',
...
add_action(
  'acf/include_fields',
  static function () use ($layoutSettingsFields) {
    acf_add_local_field_group([
      'key' => 'field-group-layout-settings',
...
$layoutLayout = [
  ...
  'name' => '_layout',
  'display' => 'block',
  'sub_fields' => $layoutFields,
  'acfe_flexible_settings' => [
    0 => 'field-group-layout-settings',
  ],
  'acfe_flexible_settings_size' => 'medium',
];

$adwp->add_inline_layout('layoutLayout', $layoutLayout, 70);

$adwp->register_layout('layout', $layoutLayout);
